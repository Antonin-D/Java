...
public class MovieDaoTestCase {
	 ...
	 * Vérifie que la méthode retourne bien les 3 films présents dans la base de données.
	 */
	 @Test
	 ...
	 * Vérifie que la méthode filtre correctement les films par genre et retourne bien les films uniquement du genre "Drama". 
	 */
	 @Test
